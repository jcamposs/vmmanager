...
Netkit.prototype.startVM = function(workspace, config, callback) {
  ...
  if (!obj._vms[workspace.getProperty("workspace")])
...
Netkit.prototype.stopVM = function(workspace, config, callback) {
  var index = this._getVmIndex(workspace, config["name"]);
  ...
  exec(script, function(error, stdout, stderr) {
    if (error !== null)
      callback("Error happened shutting down virtual machine");
    else
      callback(null);
  });
}

Netkit.prototype._getVmIndex = function(workspace, name) {
