...
var TelnetServerConn = require('./telnet').TelnetServerConn;
var TelnetClientConn = require('./telnet').TelnetClientConn;
var net = require('net');
...
Multiplexer.prototype.connect = function(callback) {
  ...
  this._timeoutId = setTimeout(function() {
    obj._vmSocket = net.connect(obj._port, obj._host, function() {
      obj._hackService = new TelnetServerConn();
      obj._hackService.on("command", function(buff) {
        logger.debug("<< ", buff);
